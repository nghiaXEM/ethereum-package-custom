...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/new/?editor=code#https://github.com/nghiaXEM/ethereum-package-custom)
...
3. Run the package with default configurations from the command line:
   ...
   ```bash
   kurtosis run --enclave my-testnet github.com/nghiaXEM/ethereum-package-custom
   ```
...
```bash
kurtosis run --enclave my-testnet github.com/nghiaXEM/ethereum-package-custom --args-file network_params.yaml
```
...
```
kurtosis run github.com/nghiaXEM/ethereum-package-custom '{"mev_type": "full"}'
```
...
This package comes with [21 prefunded keys for testing](https://github.com/nghiaXEM/ethereum-package-custom/blob/main/src/prelaunch_data_generator/genesis_constants/genesis_constants.star).
